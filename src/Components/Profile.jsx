...
const Profile = () => {
  ...
  return (
    <>
      <div className="flex h-screen bg-white justify-around max-sm:flex-col py-24 max-sm:py-14 max-sm:px-0 max-sm:items-center max-sm:flex-start">
        <div className="flex flex-col justify-between ">
          <input type="file" accept="*/*" id="profilePic" className="hidden" />
          <label htmlFor="profilePic">
            <div className="border border-gray-400 h-80 w-80">
        ...
        <div className="flex flex-col py-5">
          ...
          {editform ? (
            ...
            <div className="flex justify-end px-6">
              <button
                onClick={() => setEditForm(!editform)}
                className="bg-green-500 hover:bg-sky-500 px-6 py-2 m-1 font-extrabold text-white rounded-md"
              >
                {" "}
                Edit profile
              </button>
