...
const Footer = () => {
  return (
    <>
      <div className="flex text-xs h-60 max-sm:py-2 bg-slate-950 items-center max-sm:items-start justify-between  max-sm:px-6 py-2 max-sm:flex-col max-sm:h-auto">
      ...
      <footer className="text-slate-800 max-sm:px-2 ">
